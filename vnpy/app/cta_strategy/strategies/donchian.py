...
class Donchian(CtaTemplate):
    ...
    def __init__(self, cta_engine, strategy_name, vt_symbol, setting):
        ...
        self.bg = BarGenerator(
            self.on_bar, 4, self.on_hour_bar, interval=Interval.HOUR)
    ...
    def on_hour_bar(self, bar: BarData):
        ...
        if not self.pos:
            ...
            # if bar.close_price >= self.entry_up -10:
            ...
            # if bar.close_price <= self.exit_down +10:
            self.sell(self.exit_down, abs(self.pos), True)
