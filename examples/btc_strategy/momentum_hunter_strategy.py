...
class MomentumHunterStrategy(CtaTemplate):
    ...
    parameters = [
        "aroon_window", "boll_dev", "atr_window",
    ...
    def on_30min_bar(self, bar: BarData):
        ...
        if self.pos == 0:
            ...
            self.trading_size = int( 数量  /  self.atr_value)
           
            """
            risk_atr_value = talib.ATR(
                1 / self.am.high,
                1 / self.am.low,
                1 / self.am.close,
                self.atr_window
            ...
            self.trading_size = int(5 / risk_atr_value) # 买入多少手 / risk_atr_value 价格
